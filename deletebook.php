...
<table align="center" >
<tr><th height="100" width="400" colspan="2">BOOK DELETE</th></tr>
<tr><td>Book_id</td><td><input type="number" name="bid" ></td></tr>
...
{ 
  ...
  {   
	  ...
	  if($conn->query($sql))
		  ...
		  echo" not be delete  this book alredy issued";
