...
<table align="center" >
<tr><th height="100" width="400" colspan="2">STUDENT SEARCH BY ROLL NUMBER</th></tr>
<tr><td>Roll_number</td><td><input type="text" name="bid" pattern="m[0-9]+ca| M[0-9]+CA"></td></tr>
