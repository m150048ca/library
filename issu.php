...
<tr><td>Roll_number</td><td><input type="text" name="aname" pattern="m[0-9]+ca|M[0-9]+CA" placeholder="m150048ca"></td></tr>
...
{ 
  $aname=$_POST['aname'];
  $bid=$_POST['bid'];
  if(empty('$bid')||empty('$aname')||$bid==0)
    echo" all field are requred";
  else
  {
	  $sql="insert into issubook(roll,book_id)value('$aname','$bid')";
	  if($conn->query($sql))
		  echo" insert successfully";
	  else
		  echo" Their is no any roll or book id inserted";
